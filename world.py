...
class GameBoard():
    ...
    def main(self, ruler, resources, music_volume):
        ...
        # -------- Main Program Loop -----------
        while not done:
            start_game.message("Press 'q' to quit", WHITE)
            ...
            music_busy = start_game.pygame.mixer.music.get_busy()

            if music_busy == False:
                start_game.music_play(music_volume)
